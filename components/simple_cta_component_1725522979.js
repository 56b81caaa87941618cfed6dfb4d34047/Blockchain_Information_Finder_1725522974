            ...
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="cta-subtitle-container" class="flex">
                    <p id="cta-subtitle" class="flex-1 mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">
                        Stay ahead of the curve with real-time updates on new blockchain technologies, projects, and trends.
                    </p>
                </div>
                ...
                <div id="hey-there-button-container" class="flex mt-4">
                    <button id="hey-there-button" class="flex-1 text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Hey There
                    </button>
                </div>
            </div>
